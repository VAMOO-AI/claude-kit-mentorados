...
| Chave de assinatura ou criptografia exposta, JWT secret (A4) | `OWASP:A04:2025` · `OWASP:A07:2025` · `ISO27001:A.8.24` · `NIST-CSF:PR.DS` · `PCI-DSS:3.6` | Chave fixa é CWE-321, em A04. Quem tem a chave forja token (A07). A.8.24 e PCI 3.6 cobram a proteção da chave. |
