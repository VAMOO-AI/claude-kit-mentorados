...
| Slug calculado à mão não acha a memória (erra todo worktree) | O Claude Code troca **todo caractere fora de `[a-zA-Z0-9]`** por `-` — barra, espaço, ponto, `+`; caminho de worktree tem `.claude`. Use o comando da §1 |
